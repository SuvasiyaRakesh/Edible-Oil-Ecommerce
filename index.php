            ...
            <div class="col-md-3 w3l_fresh_vegetables_grid w3l_fresh_vegetables_grid_left">
                <div class="w3l_fresh_vegetables_grid2">
                    <ul>
                        ...
                        <li><i class="fa fa-check" aria-hidden="true"></i><a href="products.php">Vegetables</a></li>
                        <li><i class="fa fa-check" aria-hidden="true"></i><a href="products.php?id=2">Personal Care</a></li>
                        <li><i class="fa fa-check" aria-hidden="true"></i><a href="products.php?id=14">Cold Pressed & Virgin Oils</a></li>

                        <li><i class="fa fa-check" aria-hidden="true"></i><a href="products.php?id=21">Refined Oils</a></li>
                        <li><i class="fa fa-check" aria-hidden="true"></i><a href="products.php?id=5">Spices</a></li>
            ...
            <div class="col-md-9 w3l_fresh_vegetables_grid_right">
                <div class="col-md-4 w3l_fresh_vegetables_grid">
                    <div class="w3l_fresh_vegetables_grid1">
                        <img src="images/or.jpg" alt=" " class="img-responsive" />
                    </div>
                </div>
                <div class="col-md-4 w3l_fresh_vegetables_grid">
                    <div class="w3l_fresh_vegetables_grid1">
